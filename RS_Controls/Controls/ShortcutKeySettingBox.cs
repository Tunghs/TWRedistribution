...
namespace RS_Controls.Controls
{
    ...
    public class ShortcutKeySettingBox : Control
    {
        ...
        public static readonly DependencyProperty ShortcutKeyNameProperty = DependencyProperty.Register("ShortcutKeyName", typeof(string), typeof(ShortcutKeySettingBox),
        ...
        public static readonly DependencyProperty SetExtenSionProperty = DependencyProperty.Register("SetExtensions", typeof(ObservableCollection<string>), typeof(ShortcutKeySettingBox),
            new PropertyMetadata(null, null));
        public static readonly DependencyProperty ShortcutKeyProperty = DependencyProperty.Register("ShortcutKey", typeof(KeyEventArgs), typeof(ShortcutKeySettingBox),
            new PropertyMetadata(null, null));
        #endregion
        ...
        public KeyEventArgs ShortcutKey
        {
            get { return (KeyEventArgs)GetValue(ShortcutKeyProperty); }
        ...
        {
            ShortcutKeyName = e.Key.ToString();
            ShortcutKey = e;
        }
